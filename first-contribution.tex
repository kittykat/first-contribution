...
\author[Kat, Sindhu S] % (optional, use only with lots of authors)
...
\begin{frame}{Code of conduct}
  % TODO: https://wiki.gnome.org/CodeOfConduct/
...
\begin{frame}{Foundation membership}
\end{frame}
